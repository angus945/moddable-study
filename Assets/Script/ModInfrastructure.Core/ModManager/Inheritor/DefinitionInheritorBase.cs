...
namespace ModArchitecture.Definition.Inheritors
{
    ...
    public abstract class DefinitionInheritorBase<T> : IDefinitionInheritor where T : Definition
    {
        /// <summary>
        ...
        public IEnumerable<Definition> ProcessInheritance(IEnumerable<Definition> definitions)
        {
            ...
            return ProcessTypedInheritance(typedDefinitions).Cast<Definition>();
        }
