...
namespace ModArchitecture
{
    ...
    public interface IDefinitionInheritor
    {
        ...
        IEnumerable<Definition.Definition> ProcessInheritance(IEnumerable<Definition.Definition> definitions);
    }
    ...
    public class ModDefinitionInheritor
    {
        ...
        /// <returns>Processed definitions with inheritance applied</returns>
        public Dictionary<Type, List<Definition.Definition>> ProcessInheritance(Dictionary<Type, List<Definition.Definition>> definitions)
        {
            ModLogger.Log("Starting inheritance processing...", "DefinitionInheritor");
            var processedDefinitions = new Dictionary<Type, List<Definition.Definition>>();
            ...
            foreach (var kvp in definitions)
            {
                ...
                List<Definition.Definition> defList = kvp.Value;
        ...
        private IEnumerable<Definition.Definition> ProcessDefaultInheritance(List<Definition.Definition> definitions)
        {
            // Create a map for quick lookup
            var definitionMap = definitions.ToDictionary(def => def.defID, def => def);
            var processedDefinitions = new List<Definition.Definition>();
        ...
        private Definition.Definition ProcessSingleInheritance(Definition.Definition definition, Dictionary<string, Definition.Definition> definitionMap)
        {
