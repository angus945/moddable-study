...
namespace ModArchitecture.Utils
{
    ...
    public static class DefinitionInheritanceUtils
    {
        ...
        public delegate void InheritanceAction<T>(T child, T parent) where T : ModArchitecture.Definition.Definition;
        ...
        public static IEnumerable<T> ProcessInheritance<T>(
            ...
            InheritanceAction<T> specificInheritanceAction = null) where T : ModArchitecture.Definition.Definition
        {
        ...
        private static List<T> TopologicalSort<T>(List<T> definitions) where T : ModArchitecture.Definition.Definition
        {
        ...
        private static T ProcessSingleDefinitionWithRecursion<T>(
            ...
            InheritanceAction<T> specificInheritanceAction) where T : ModArchitecture.Definition.Definition
        {
        ...
        private static List<T> BuildInheritanceChain<T>(T definition, Dictionary<string, T> definitionMap) where T : ModArchitecture.Definition.Definition
        {
        ...
        public static void ApplyCommonInheritance<T>(T definition, T parentDefinition) where T : ModArchitecture.Definition.Definition
        {
