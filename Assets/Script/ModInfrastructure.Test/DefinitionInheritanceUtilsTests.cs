...
namespace ModInfrastructure.Test
{
    ...
    public class DefinitionInheritanceUtilsTests
    {
        ...
        /// </summary>
        [Test]
        public void TestInheritNumericProperty_WithDefaultValue_ShouldInherit()
        {
            // Arrange
        ...
        /// </summary>
        [Test]
        public void TestInheritNumericProperty_WithNonDefaultValue_ShouldNotInherit()
        {
            // Arrange
            var parent = new CharacterDef { health = 100 };
        ...
        /// </summary>
        [Test]
        public void TestInheritStringProperty_WithEmptyValue_ShouldInherit()
        {
            // Arrange
        ...
        /// </summary>
        [Test]
        public void TestInheritStringProperty_WithNullValue_ShouldInherit()
        {
            // Arrange
            var parent = new CharacterDef { label = "Parent Label" };
        ...
        /// </summary>
        [Test]
        public void TestInheritStringProperty_WithExistingValue_ShouldNotInherit()
        {
            // Arrange
            var parent = new CharacterDef { label = "Parent Label" };
        ...
        /// </summary>
        [Test]
        public void TestMergeListProperty_WithNullChildList_ShouldCreateNewList()
        {
            // Arrange
        ...
        /// </summary>
        [Test]
        public void TestMergeListProperty_WithExistingChildList_ShouldMerge()
        {
            // Arrange
        ...
        /// </summary>
        [Test]
        public void TestInheritProperty_WithCustomPredicate_ShouldUseCustomLogic()
        {
            // Arrange
            var parent = new CharacterDef { health = 100 };
        ...
        /// </summary>
        [Test]
        public void TestInheritProperty_WithCustomPredicateFalse_ShouldNotInherit()
        {
            // Arrange
            var parent = new CharacterDef { health = 100 };
        ...
        /// </summary>
        [Test]
        public void TestInheritComplexProperty_WithNullChildObject_ShouldCreateNew()
        {
            // Arrange
        ...
        /// </summary>
        [Test]
        public void TestPerformanceWithLargeInheritanceChain()
        {
