...
//             // 模擬一些測試結果
//             AutoTestCapture.CaptureTestResult("Demo_Test_1", true, "✓ 測試通過", 12.5);
//             AutoTestCapture.CaptureTestResult("Demo_Test_2", false, "✗ 測試失敗：期望值不匹配", 8.3);
//             AutoTestCapture.CaptureTestResult("Demo_Test_3", true, "✓ 驗證成功", 15.7);

//             // 執行測試並自動記錄結果
//             AutoTestCapture.ExecuteTest("Demo_ExecuteTest", () =>
//             {
//                 // 模擬一些測試邏輯
//                 int result = 2 + 2;
//                 AutoTestCapture.VerifyEqual("Demo_ExecuteTest", "Addition", 4, result);
//             });

//             // 輸出結果
//             AutoTestCapture.WriteAllCapturedResults("AutoCaptureDemo");
