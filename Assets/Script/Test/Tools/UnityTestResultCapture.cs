...
namespace Test.Tools
{
    ...
    /// </summary>
    public static class UnityTestResultCapture
    {
        ...
        /// 編輯器工具：手動觸發測試結果輸出
        /// </summary>
        public static class TestResultCaptureEditor
        {
            [UnityEditor.MenuItem("Tools/Test Results/Write Captured Results")]
            public static void WriteCapturedResults()
            {
                UnityTestResultCapture.WriteAllCapturedResults();
            }

            [UnityEditor.MenuItem("Tools/Test Results/Clear Captured Results")]
            public static void ClearCapturedResults()
            {
            ...
            [UnityEditor.MenuItem("Tools/Test Results/Show Captured Stats")]
            public static void ShowCapturedStats()
            {
                var (total, passed, failed) = UnityTestResultCapture.GetCapturedStats();
                Debug.Log($"捕獲的測試統計: 總計 {total}, 通過 {passed}, 失敗 {failed}");
            }
        }
#endif
    }
